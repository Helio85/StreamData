        ...
        <LoginInfo>
          ...
          <SignInButton onPress={handleSignIn}>
            <SignInButtonIcon>
              ...
              {isLoggingIn ? (<ActivityIndicator color={theme.colors.white} size={20}/>) :
                (<Fontisto name={'twitch'} color={theme.colors.white} size={20} style={{marginRight: 1}}/>)}
            </SignInButtonIcon>
            ...
            <SignInButtonText>
              ...
              {isLoggingIn === true ? 'Entrando...' : 'Entrar com Twitch'}
            </SignInButtonText>
          </SignInButton> 
        </LoginInfo>
      </Content>
